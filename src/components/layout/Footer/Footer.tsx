...
const Footer: React.FC = () => {
  ...
  const socialLinks: SocialLink[] = [
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/marwa-rabia',
    ...
    {
      name: 'Email',
      url: 'mailto:marwa.rabia@example.com',
          ...
          <div className={styles.footer__section}>
            ...
            <ul className={styles.footer__links}>
              <li className={styles.footer__linkItem}>
                <a
                  href="mailto:marwa.rabia@example.com"
                  className={styles.footer__link}
                >
                  marwa.rabia@example.com
                </a>
              </li>
              <li className={styles.footer__linkItem}>
                <a
              ...
              <li className={styles.footer__linkItem}>
                <a
                  href="https://www.linkedin.com/in/marwa-rabia"
                  target="_blank"
                  rel="noopener noreferrer"
                  className={styles.footer__link}
                >
