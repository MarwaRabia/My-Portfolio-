...
export const skills: Skill[] = [
  ...
  // Backend
  { name: 'ASP.NET Core', icon: 'dotnet', color: '#512BD4', category: 'backend' },
  { name: 'Node.js', icon: 'nodejs', color: '#339933', category: 'backend' },
  { name: 'SQL Server', icon: 'database', color: '#CC2927', category: 'backend' },
  ...
  // Other
  { name: 'Responsive Design', icon: 'responsive', color: '#667eea', category: 'other' },
  { name: 'Performance', icon: 'performance', color: '#764ba2', category: 'other' },
  { name: 'Accessibility', icon: 'accessibility', color: '#f093fb', category: 'other' },
];
